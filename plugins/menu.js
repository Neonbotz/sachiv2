 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `| 🧾 | ${pmenus} SEMUA PERINTAH`, rowId: ".? all", description: "Menampilkan Semua command BOT"},
	...
	{title: `| 🐚 | ${pmenus} KERANG AJAIB`, rowId: ".? kerangajaib", description: "Tanyakan pada ketua club"},
	...
	{title: `| 🌠 | ${pmenus} STICKER`, rowId: ".? stiker", description: "Buat Sticker diBOT"},
